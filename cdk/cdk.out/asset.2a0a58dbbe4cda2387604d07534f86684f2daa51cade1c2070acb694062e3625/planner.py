...
class CrewAIPlanner:
    ...
    def execute_agent_workflow(self, crew_config: Dict, user_input: str, system_prompt: str) -> Dict:
        """병렬 에이전트 워크플로우 실행 (프롬프트 카드별 병렬 처리)"""
        ...
        # 병렬 처리를 위한 작업 함수
        def process_agent_task(title_type, agent_key, type_name):
...
"""
            ...
            return title_type, title_result, titles
        ...
        with ThreadPoolExecutor(max_workers=5) as executor:
            ...
            for future in futures:
                title_type, title_result, titles = future.result()
