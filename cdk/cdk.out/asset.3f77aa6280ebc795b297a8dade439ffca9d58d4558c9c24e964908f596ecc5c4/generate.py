        ...
        if len(user_input) < 10:
            return {
                ...
                'body': json.dumps({
                    ...
                    'result': f'현재 입력하신 내용이 {len(user_input)}자입니다. 더 정확한 결과를 위해 구체적인 내용을 입력해주세요.',
                    'mode': 'guidance'
                }, ensure_ascii=False)
            }
...
# 이전의 복잡한 함수들은 모두 제거되었습니다.
# - handle_direct_conversation
# - handle_prompt_based_conversation
# - determine_task_type 